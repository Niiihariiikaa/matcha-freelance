...
function CTA() {
  return (
    <section className="relative bg-gradient-to-b from-[#E8D5C4] to-[#D4C0AE] py-24 px-8">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-5xl lg:text-7xl font-paytone text-[#4A5D3F] mb-12 leading-tight">
